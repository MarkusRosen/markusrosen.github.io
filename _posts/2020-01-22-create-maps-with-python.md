...
- [Add a background map to the plot](#add-a-background-map-to-the-plot)
- [Show a KDE plot of the spatial distribution](#show-a-kde-plot-of-the-spatial-distribution)
- [Color the markers with the KDE information](#color-the-markers-with-the-kde-information)
- [Use more specific symbols as map markers](#use-more-specific-symbols-as-map-markers)
